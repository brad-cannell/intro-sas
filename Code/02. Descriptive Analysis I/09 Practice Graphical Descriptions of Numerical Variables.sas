...
* Step 2:
* Create a summary report with plots for the variable lskew using PROC
* UNIVARIATE;
* ============================================================================;
...
* In the boxplot the median is towards the top of the box (above the mean), the
* lower whisker is longer than the upper whisker, and there are more outliers in
* the lower range.
