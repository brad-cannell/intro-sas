...
* The PROC MEANS step with all the default statistics, along with the median and
* mode, for participant weight only. Also limiting the number of decimal places
* displayed to two;
* ============================================================================;
