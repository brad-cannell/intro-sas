...
* Step 1.
* Highlight and submit the data step below;
* ============================================================================;
data bmi;
	input id $ sex $ bmi & $23.;
	datalines;
...
* Step 2. Create a vertical bar chart for the variable BMI that includes data
...
* Step 3. Create a horizontal bar chart for the variable BMI that includes a
* table of frequency statistics;
* ============================================================================;
proc gchart data = bmi;
	hbar bmi;
run;

/* ===== 52.63% are neither overweight nor obese ===== */
