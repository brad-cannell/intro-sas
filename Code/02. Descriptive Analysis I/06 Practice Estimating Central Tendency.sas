...
* Practice: Estimating Measures of Central Tendency
...
* Step 1. Highlight and submit the data step below;
* ============================================================================;
...
* Step 2:
* Requesting the default statistics, along with the median and mode, for
* participant height and weight. Also limiting the number of decimal places
* displayed to two;
* ============================================================================;
...
* Red flags:
* There are only 19 non-missing values for the wgt_lbs variable.
* The minimum value for ht_in is -69, an impossible value for height;
