...
* Use the SGPLOT procedure to graphically investigate the relationship between
* the variable read and the variable write.
...
* Read and write appear to be positively correlated in this scatter plot.
...
* The results of PROC CORR confirm our previous findings. Read and write are
* strongly, and statistically significantly,
