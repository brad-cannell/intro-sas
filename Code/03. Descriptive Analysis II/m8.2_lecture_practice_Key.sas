...
/*
Use the SGPLOT procedure to create a side-by-side boxplot for the variable math over levels of the variable prog.
Which program appears to produce the highest math scores?
*/
...
/*
The results of PROC MEANS confirm our previous findings. With a mean score of 56.7, program #2 appears to produce the
highest average math scores.
*/
