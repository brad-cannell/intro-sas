...
* Which program is comprised of the highest proportion of students who are low
* SES?;
* ============================================================================;
proc freq data = hsb1;
	tables prog * ses;
...
* With 35.56% of the students in Program #1 are low SES. This is a higher
* proportion of students who are low SES than any other program;
